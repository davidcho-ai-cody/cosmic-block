...
public static class VisualReadabilityBuilder {
 ...
 public static void Validate(){
  ...
  var area=GameObject.Find("GameCanvas").transform.Find("SafeArea/BlockArea");Require(area.childCount==3,"Three slots");foreach(Transform child in area)Require(child.GetComponent<SlotVisual>()!=null&&child.GetComponent<Outline>()!=null,"Slot visual "+child.name);
